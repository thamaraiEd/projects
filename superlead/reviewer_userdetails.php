					...
					foreach($reviewerlist as $row)
					{
						...
						<tr> 
							...
							<td>
								...
								{
								?>
									<input type="button"  data-taskname="<?php echo $row["task_name"]; ?>" data-projectname="<?php echo $row["project_name"]; ?>" data-logdate="<?php echo $row["log_date"]; ?>" data-id="<?php echo $row['id']; ?>" data-uid="<?php echo $row['user_id']; ?>"  id="btnapprove" name="btnapprove"  class="btn btn-success show_popup_review clsapprove"  value="Approve"  data-toggle="modal" > 
								<?php
								}
								?>								
							</td> 
...
<div id="ARModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-center">
                          <form class="form-horizontal"  role="form" name="frmAR" id="frmAR"> 
						   ...
						   <div id="suucessmsg" style="color: green; font-size:20px; font-weight:600; text-align: center;"></div>
							...
							<h4>Task Name: <span id="tname" style="color: green;"></span> </h4> 
                                <fieldset>
                                    ...
                                    <input class="btn btn-lg btn-primary btn-block" value="Submit" type="button" id="btnAR" name="btnAR">
