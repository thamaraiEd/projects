 <h4 class="reporttitle">Director List </h4>
...
<div id="DirModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-center">
                          <form class="form-horizontal"  role="form" name="frmDir" id="frmDir"> 
						   ...
						   <div id="suucessmsg" style="color: green; font-size:20px; font-weight:600; text-align: center;"></div>
							...
							<h4>Remarks: <span id="remarks_byre" style="color: green;"></span> </h4> -->
                                <fieldset>
                                    ...
                                    <input class="btn btn-lg btn-primary btn-block" value="Submit" type="button" id="btnDir" name="btnDir">
