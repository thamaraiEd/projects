...
/* 	public function updateChildFailureUser_PB($stdid,$paymentstatus)
	...
	public function InsertEnquiryEntry($schoolname,$contactname,$email,$country_id,$mobile_prefix,$contactnumber,$txtaddress,$txtmessage,$ddlProgram)
	{
		$query = $this->db->query(" INSERT INTO school_enquiry_form(schoolname, contact_name, country, mobile_prefix, mobileno, email_id, address, message, submited_date,program) VALUES('".$schoolname."','".$contactname."','".$country_id."','".$mobile_prefix."','".$contactnumber."','".$email."','".$txtaddress."','".$txtmessage."','".date('Y-m-d H:i:s')."','".$ddlProgram."') "); 
