<div id="" class="container playGames homePlayGames" style="margin-top:20px;margin-bottom:70px;">
	<form name="frmRegister" id="frmRegister" class="" method="post" enctype="multipart/form-data" >
	  <div class="row">
		<div class="col-lg-12">
		<h1 style="margin:0 0 30px;text-align: center;padding-bottom: 7px;"><span style="padding-bottom:5px;color:#000;">Registration Failure</span> </h1>
		 </div></div>
		 <div class="row">
 		  <div class="alert alert-success fade in alert-dismissible" style="margin-top:18px;">
     <i class="fa fa-exclamation-triangle" style="color#fff;"></i><strong>Oops!</strong> We had trouble processing the payment. Please try again !!!
</div>
