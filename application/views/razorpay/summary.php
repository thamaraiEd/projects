...
<div class="row">
    <div class="col-lg-12 text-center">
        <h2 class="panel-title">Checkout Page</h2>                 
    </div>
</div><!-- /.row -->
					...
					<div class="col-md-12">
						<div class="frmfreereg invoice">
							<div class="grid-body">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="col-md-6 col-sm-6 col-xs-6 text-left">
												<h3 style="margin:0px;" class="panel-title-left"><strong>Order ID</strong><br>
								...
								<div>
									<div class="col-md-12">										
											<h3 class="panel-title1">User Information</h3>
											<div class="user_info row">												
													<div class="col-md-12"><span class="summary-label">Name:</span> <span class="summary-control"> <?php echo $this->session->temp_User; ?></span></div>				
													<div class="col-md-12"><span class="summary-label">Mobile No:</span> <span class="summary-control"><?php echo $this->session->temp_Mobile; ?></span></div>
													<div class="col-md-12"><span class="summary-label">Email:</span> <span class="summary-control"><?php echo $this->session->temp_Email; ?></span></div>
												</div>
											</div>										
									</div>  
								</div> 
