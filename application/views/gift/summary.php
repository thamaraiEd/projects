<?php
$order_id="EdB2C_".$gift_pay_id;
$productinfo=$this->session->gift_plan;
$txnid = time();
$surl = $surl;
$furl = $furl;        
$key_id = RAZOR_KEY_ID;
$currency_code = $currency_code;            
/* $total = ($this->session->gift_price * 100); 
$amount = $this->session->gift_price; */
$total = 1* 100; 
$amount = 1;
$merchant_order_id = $order_id;
$card_holder_name =$this->session->gift_username;
$email=$this->session->gift_email;
$phone=$this->session->gift_mobile;
$name= APPLICATION_NAME;
$return_url = site_url().'index.php/gift/callback';
...
<div class="row">
 ...
 <form name="razorpay-form" id="razorpay-form" action="<?php echo $return_url; ?>" method="POST">
  ...
  <input type="hidden" name="merchant_id" id="merchant_id" value="1"/>
										...
										<div class="col-xs-6">
											...
											<div class="user_info">
												<div class="col-xs-12">
													...
													<div class="col-xs-6"> <?php echo $this->session->gift_username; ?></div>
												</div>
												<div class="col-xs-12">
													<div class="col-xs-3 nopad">Mobile No</div><div class="col-xs-1 nopad"> : </div>
													<div class="col-xs-6">  <?php echo $this->session->temp_country_code." ".$this->session->gift_mobile; ?></div>
												</div>
												<div class="col-xs-12">
													<div class="col-xs-3 nopad">Email</div><div class="col-xs-1 nopad"> : </div>
													<div class="col-xs-6">  <?php echo $this->session->gift_email; ?></div>
												</div>
											</div>
										</div>  
									</div>  
								...
								<div class="row" style="margin:20px 0px;">
									<div class="col-md-12">
										...
										<table class="table table-bordered table-hover table-striped print-table order-table">
											...
											<tbody>
												<tr>
													<td class="text-center"><?php echo $this->session->gift_plan;?></td>
													<td class="text-center"><?php echo $this->session->gift_price;?></td>
													<td class="text-center"><?php echo $this->session->gift_plan_duration;?></td>
													<td class="text-center"><?php echo $this->session->gift_price;?></td>
												</tr>  
												<tr>
													<td colspan="2"></td>
													<td class="text-center"><strong>Total</strong></td>
													<td class="text-center"><strong><?php echo $currency_code." ".$this->session->gift_price;?></strong></td>
												</tr>
											</tbody>
										</table>
									</div>									
