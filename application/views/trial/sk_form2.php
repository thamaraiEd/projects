...
<div class="col-md-6 leftHalf">
	<img data-src="<?php echo base_url(); ?>assetsnew/images/png/sk_logo.png" alt="SkillAngels" class="platformsupport lazyload" style="margin: 30% 0 3% 0; 
     left:0; right:0;" /> 
    <br>
        ...
        <div class="row">
 				...
 				<div id="successmsg" style="color: green; font-size:20px; font-weight:600; text-align: center;"></div>		 
                    ...
                    <div class="form-group">
						<div class="row"> 
							<div class="col-md-12">
								<label class="control-label">Email ID <span style="color:red"> : </span>
						...
						<div class="row"> 
							<div class="col-md-12">
								...
								<input type="hidden" maxlength="150" class="form-control" name="schoolname" value="<?php 
						...
						<div class="row">
                            <div class="col-md-6">
								...
								<input type="text" maxlength="150" class="form-control alphaOnly" name="studentname" value="<?php 
						...
						<div class="row"> 
							<div class="col-md-6">								
									...
									<div class="row">
										<div class="col-md-12">
											<input type="text" readonly='true'  class="form-control DatenumbersOnly" name="txtdob" value="" id="txtdob"  required> 
										</div>
									</div>
							</div>
							<div class="col-md-6">
...
$(document).ready(function() {
 var today = new Date();
$("#txtdob" ).datepicker({ endDate: "today",changeYear: true,maxDate: today,dateFormat: 'dd-mm-yy'});
});
</script>
<script>
