									...
									<div class="row">
										<div class="col-lg-4 col-md-4">
											<div class="form-group">
												...
												<select name="ddlworktype" id="ddlworktype" class="form-control input-sm"> 
													<option value="">Select</option> 
														<?php foreach($CompWorkType as $row)
														{
															echo "<option id='".$row['id']."' value='".$row['id']."'>".$row['type']."</option>";
														} ?> 
												</select>												
											</div>
										</div> 
...
$("#frmaddactivity").validate({
	...
	{  
		if($("#frmaddactivity").valid())
		{
			...
			$.ajax({
					url: "<?php echo base_url(); ?>index.php/comp/insert_activity",
					type:"POST",
					dataType:"json",
					data:formData,
					contentType: false,       
