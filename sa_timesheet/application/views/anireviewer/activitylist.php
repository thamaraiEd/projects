...
<h4 class="reporttitle">Reviewer Activity List </h4>
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="row">
			<h4>&nbsp;&nbsp;<u><a id="addactivity" class="addactivity" href="<?php echo base_url('index.php/reviewer/addactivity'); ?>"><i class="fa fa-plus"></i>Add Activity</a></u>
			</h4>
		</div>
		<div class="row">
					...
					foreach($activitylist as $row)
					{
						...
						<tr> 
							...
							{ //echo $row["lead1_approved_status"]."==".$row["lead2_approved_status"];exit;
								...
								{
							?>
									<a href="<?php echo base_url(); ?>index.php/reviewer/editactivity?&rowid=<?php echo $row["id"]; ?>" class="Edit_Btn" id="<?php echo $row["log_date"]; ?>" > Edit </a>
							<?php
								}
								else
								{
