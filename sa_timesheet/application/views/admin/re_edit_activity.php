...
$("#frmaddactivity").validate({
        ...
        messages: {
			...
			"txtprojectname": {required: "Please enter shot name"},
			"txttaskname": {required: "Please enter number of characters"} 
        },
	...
	{   
		if($("#frmaddactivity").valid())
		{
			...
			$.ajax({
			url: "<?php echo base_url(); ?>index.php/admin/review_update_activity",
			type:"POST",
			dataType:"json",
			data:formData,
			contentType: false,       
