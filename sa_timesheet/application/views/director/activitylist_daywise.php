		...
		<form id="frmdaywisedata" method="POST">  
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-4 clstotal">
					<div class="col-sm-4"><label class="">Select User </label></div>
					<div class="col-sm-8">
				...
				<div class="col-md-6 col-sm-6 col-xs-6 clstotal">
					<div class="col-sm-2"><label class="">Select User </label></div>
					<div class="col-sm-3">
...
{ 
	...
	if(month_year!='' && user_id!='')
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>index.php/home/getDirUserDayData",
