				...
				<tbody>
					...
					foreach($reviewerlist as $row)
					{
						...
						<tr> 
							...
							<td>
								<input type="button"  data-remarks="<?php echo $row["remarks"]; ?>" data-taskname="<?php echo $row["task_name"]; ?>" data-projectname="<?php echo $row["project_name"]; ?>" data-logdate="<?php echo $row["log_date"]; ?>" data-id="<?php echo $row['id']; ?>" data-uid="<?php echo $row['user_id']; ?>"  id="btnapprove" name="btnapprove"  class="btn btn-success show_popup_review clsapprove"  value="Approve"  data-toggle="modal" >  
							</td> 
							<?php 
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="text-center">
                          <form class="form-horizontal"  role="form" name="formAR" id="formAR"> 
