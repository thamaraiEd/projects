				...
				<tbody>
					...
					foreach($reviewerlist as $row)
					{
						...
						<tr> 
							...
							<td>
								<!--<input type="button"  data-remarks="<?php echo $row["remarks"]; ?>" data-taskname="<?php echo $row["task_name"]; ?>" data-taskduration="<?php echo $row["task_duration"]; ?>" data-projectname="<?php echo $row["project_name"]; ?>" data-logdate="<?php echo $row["log_date"]; ?>" data-id="<?php echo $row['id']; ?>" data-uid="<?php echo $row['user_id']; ?>"  id="btnapprove" name="btnapprove"  class="btn btn-success show_popup_sba clsapprove"  value="Approve"  data-toggle="modal" > -->

								<input type="button"  data-remarks="<?php echo $row["remarks"]; ?>" data-taskname="<?php echo $row["task_name"]; ?>" data-taskduration="<?php echo $row["task_duration"]; ?>" data-projectname="<?php echo $row["project_name"]; ?>" data-logdate="<?php echo $row["log_date"]; ?>" data-id="<?php echo $row['id']; ?>" data-uid="<?php echo $row['user_id']; ?>"  data-rowid="show_popup_sba<?php echo $i; ?>" id="btnapprove" name="btnapprove"  class="btn btn-success show_popup_sba clsapprove"  value="Approve"  data-toggle="modal" >  
							...
							<h4>Remarks: <span id="remarks_byre" style="color: green;"></span> </h4> 
                                <fieldset>
                                    ...
                                    <div class="form-group"> 
										 <input class="form-control input-lg" placeholder="Completed Duration" name="txtcompleted_duration" type="text" id="txtcompleted_duration">  
 										</div>
                                    <div class="form-group"> 
									 ...
									 <input type="hidden" id="hdntask_duration" name="hdntask_duration" value="" />  

									  <input type="hidden" id="hdnrowid" name="hdnrowid" value="" />
									   <input type="hidden" id="hdnuid" name="hdnuid" value="" /> 
									</div>
                                    <input class="btn btn-lg btn-primary btn-block" value="Submit" type="button" id="btnSBAbtn" name="btnSBAbtn">
