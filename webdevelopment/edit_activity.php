				...
				<div class="registrationarea">
					<div id="mainContDisp" class="container playGames"> 
						<form name="frmaddactivity" id="frmaddactivity"  class="" method="post" enctype="multipart/form-data" accept-charset="utf-8">
							<h4 class="card-category text-center">Edit Activity</h4> 
									...
									<div class="row">
										...
										<div class="col-lg-4 col-md-4">
											...
											<label class="" for="shotname">Project Name <span style="color:red" class="mstar">*</span></label>
												<select  name="txtprojectname" id="txtprojectname" class="form-control selectpicker">
													<option value="<?php echo $userdata[0]['project_name']; ?>" ><?php echo $userdata[0]['projectname']; ?></option>
												</select>
											</div> 
										</div> 
										<div class="col-lg-4 col-md-4">
											...
											<select class="form-control dropdown" name="ddlworktype" required id="ddlworktype">
												...
												<option <?php if($type['id']==$userdata[0]['work_type'] )
												{ ?>selected="selected"<?php } ?> value="<?php echo $type['id']; ?>"><?php echo $type['type']; ?></option>
												<?php } ?>
											</select>
											</div> 
										</div> 
									...
									<div class="row">
										<div class="col-lg-4 col-md-4">
											...
											<select class="form-control dropdown" name="ddlworkstatus" required id="ddlworkstatus">
												...
												<option <?php if($status['id']==$userdata[0]['work_status'] )
												{ ?>selected="selected"<?php } ?> value="<?php echo $status['id']; ?>"><?php echo $status['work_status']; ?></option>
												<?php } ?>
											</select>
											</div> 
										</div> 
										<div class="col-lg-4 col-md-4">
											...
											<select class="form-control dropdown" name="ddlworkplatform"  id="ddlworkplatform">
												...
												<option <?php if($plat['id']==$userdata[0]['work_platform'] )
												{ ?>selected="selected"<?php } ?> value="<?php echo $plat['id']; ?>"><?php echo $plat['platform']; ?></option>
												<?php } ?>
											</select>
											</div> 
										</div>
										...
										<div class="col-lg-4 col-md-4">
											...
											<input type="text"  class="form-control shotname" required maxlength="801" name="txttaskname" value="<?php echo $userdata[0]['task_name']; ?>"  id="txttaskname"  > 
											</div> 
										</div> 
...
$("#frmaddactivity").validate({
        ...
        messages: {
			...
			"txttaskname": {required: "Please enter taskname",maxlength:"Please enter up to 800"} ,
	...
	{   
		if($("#frmaddactivity").valid())
		{
			...
			$.ajax({
			url: "<?php echo base_url(); ?>index.php/Wdev/update_activity",
			type:"POST",
			dataType:"json",
			data:formData,
			contentType: false,       
			...
			{ 
				...
				{
					 window.location="<?php echo base_url(); ?>index.php/wdev/activitylist"
				}
				else
				{ 
...
$(document).ready(function() { 
	 var today = new Date(); 
	$("#txtcurdate" ).datepicker({ minDate: -2,endDate: "today",maxDate: today,dateFormat: 'dd-mm-yy'});
